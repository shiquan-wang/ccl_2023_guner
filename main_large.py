...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', type=str, default='./config/bisai_large.json')
    ...
    for i in range(config.epochs):
        ...
        if f1 > f1_threshold:
            if f1 >= best_f1:
                best_epoch = i
                best_f1 = f1
            logger.info('get beyond f1 result: {}'.format(i))
            logger.info(" beyond f1 threshold epoch: {}".format(best_epoch))
