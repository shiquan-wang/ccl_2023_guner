...
if __name__ == '__main__':
    ...
    flag = 1
    dev_path = 'data/jian_data/dev.json'
    ...
    dev_output_file = config.outpath +'{}_{}_dev_result.txt'.format(model_name, config.model_version)
    with open(dev_output_file, 'w', encoding='utf-8') as f:
        json.dump(dev_result, f, ensure_ascii=False)

    pre_output_file = config.outpath + '{}_{}_predict_result.txt'.format(model_name, config.model_version)
